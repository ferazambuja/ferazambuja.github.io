...
def comparator_feature(comparator_root: Path) -> str:
    ...
    return (
        ...
        'has higher coefficients of determination for brightness and chroma '
        'and a lower one for colorfulness.</p>'
...
def comparator_page(comparator_root: Path, docs: dict) -> str:
    ...
    body = (
        ...
        'in the paper, the proposal has higher coefficients of determination for '
        'brightness and chroma and a lower one for colorfulness. '
